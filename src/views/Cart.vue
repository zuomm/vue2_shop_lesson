<template>
  <div>
    <body class="checkout cart-page">
                          ...
                          <li v-for="(item,index) in cartList" :key="index">
                              <div class="cart-tab-1">
                                  <div class="cart-item-check">
                                      <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'check':item.checked == '1'}" @click="editCart('',item)">
      ...
      <!-- 确认删除弹窗 -->
        <modal :mdShow ="mdConfirm" v-on:close="closeModal"><!--开关变量 mdShow-->
...
export default {
  ...
  methods:{
    ...
    toggleCheckAll(){
        /** 
         * 只有两个结果，如果this.checkAllFlag = false,
         *    即只要有一个没选中，则全部选中；
         *    当前为全选状态则设置为全部非选中   
        */
        var flag = !this.checkAllFlag;//当前为全选状态则设置为全部非选中false,flag则为true
